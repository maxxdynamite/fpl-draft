                ...
                return (
                  ...
                  >
                    <Image
                      ...
                      width={20}
                      height={20}
                      className="h-5 w-5 rounded-full object-cover object-[center_25%]"
                    />
                    {player.name}
              ...
              return (
                ...
                >
                  <Image
                    ...
                    width={36}
                    height={36}
                    className={`h-9 w-9 rounded-full object-cover object-[center_25%] bg-black/[0.04] dark:bg-white/[0.06] shrink-0 ${
