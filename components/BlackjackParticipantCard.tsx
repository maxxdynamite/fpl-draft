      ...
      {participant.players && (
        <div className="absolute inset-x-0 top-0 h-1 bg-black/[0.06] dark:bg-white/[0.08]">
          {/* Brand gradient (same green-to-cyan as the Q badge/qualified
              ...
              avatars) - but zinc-800, not the pill's actual black. Bust is
              ...
              zinc-600/zinc-700 fixed that but read too bold for a muted
              state - zinc-800 is the darkest shade that still stays
              perceptible against the card. */}
          <div
            className={`h-full ${isBust ? "bg-zinc-800" : "bg-gradient-to-r from-[#00ff85] to-[#04f5ff]"}`}
